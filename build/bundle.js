...
/***/ function(module, exports, __webpack_require__) {
	...
	var _anagram = __webpack_require__(1);
	...
	var Checker = _react2.default.createClass({
	  displayName: 'Checker',
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'form',
	      { id: 'checker' },
	      _react2.default.createElement('input', { type: 'text', id: 'word1', value: this.state.word1, onChange: this.onWord1Change, placeholder: 'Word 1' }),
	      _react2.default.createElement('input', { type: 'text', id: 'word2', value: this.state.word2, onChange: this.onWord2Change, placeholder: 'Word 2' }),
	      _react2.default.createElement(
	        'label',
	        { id: 'result', className: this.state.anagram ? "correct" : "incorrect" },
	        this.state.anagram ? "Anagram" : "Not anagram"
	      )
	    );
	  },
	  onWord1Change: function onWord1Change(event) {
	    this.setState({ word1: event.target.value, anagram: (0, _anagram2.default)(event.target.value, this.state.word2) });
	  },
	  onWord2Change: function onWord2Change(event) {

	    this.setState({ word2: event.target.value, anagram: (0, _anagram2.default)(this.state.word1, event.target.value) });
	  }
	});

	window.onload = function () {
	  _reactDom2.default.render(_react2.default.createElement(Checker, null), document.getElementById("main"));
	};
...
/***/ function(module, exports) {
	...
	exports.default = function (word1, word2) {
	  ...
	  for (var l = 0; l < word1.length; l++) {
	    var letter = word1[l];
	    if (letters[letter] == null) letters[letter] = 1;else letters[letter] += 1;
	  }
